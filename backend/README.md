...
## Project Structure
    ...
    ├── testingdevstring_d_116414  # Django project configurations
...
1. Clone this repo and `cd testingdevstring_d_116414`
...
2. Clone this repo and `cd testingdevstring_d_116414`
